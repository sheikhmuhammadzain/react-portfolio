  ...
  return (
    <>
      ...
      >
        ...
        {status === "connecting" && (
          <span className="absolute inset-0 z-10 rounded-full border-2 border-white/80 border-t-transparent animate-spin" />
        )}
        {status === "error" && (
          <span className="absolute inset-0 z-10 rounded-full ring-2 ring-inset ring-red-500/80" />
        )}
      </button>
