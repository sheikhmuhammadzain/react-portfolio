// Perlin-noise shaders for the voice-call ball (classic cnoise by Stefan Gustavson).
// Kept as JS strings so Vite bundles them instead of reading <script> tags from the DOM.
